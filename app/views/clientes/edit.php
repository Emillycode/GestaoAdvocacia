<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    <h2 class="mb-0 fw-bold">Editar Cliente</h2>
        ...
        <form action="<?= BASE_URL ?>/clientes/editar/<?= $cliente['id'] ?>" method="POST">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="tel" name="telefone" class="form-control" value="<?= htmlspecialchars($cliente['telefone']) ?>">
                </div>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-4">
                <label class="form-label fw-semibold small text-secondary">Observações</label>
